...
Код находится в папке 2 семестр Lab4. В файле Class_lab4.hpp написан код класса, а в файле Lab4.cpp этот класс применяется
...
Код находиться в папке 2 семестр Lab5, в файле Class_lab5.hpp находиться класс, а в файле Lab5.cpp он применяется.
...
Спецификация шаблона находиться в файле Class_lab6.hpp, а применяется он в файле Lab6.cpp

## Седьмая лабораторная работа
### Тема: Чтение файлов различных типов

Она зачтена благодаря бонусу за возложение цветов
![Alt text](source/bonus_img/Assignment.jpg?raw=true "Assignment!")

## Восьмая лабораторная работа
### Тема: Подключение библиотеки
...
Исходники библиотеки находятся в папке SFML, подключается и проверяется она в файле main.cpp
